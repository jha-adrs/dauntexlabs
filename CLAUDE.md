...
55 live tools + 1 under-maintenance page across 9 categories (Utilities, Converters, Formatters, Generators, Data Tools, Image Tools, PDF Tools, Text Tools, Web & CSS).
...
npm test           # vitest run — 457 behavior tests, one suite per tool
