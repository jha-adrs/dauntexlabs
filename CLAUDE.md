...
37 live tools + 1 under-maintenance page across 7 categories (Utilities, Converters, Formatters, Generators, Data Tools, Image Tools, PDF Tools).
...
npm test           # vitest run — 266 behavior tests, one suite per tool
